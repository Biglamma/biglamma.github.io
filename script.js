...
// This is for sorting items by cost and spreading rarity tiers evenly across the pool
...
function showSplash(item) {
  ...
  splash.innerHTML = `
    <div class="splash-content" style="border-color:${col}">
      ...
      <div class="splash-rarity" style="color:${col}">${CONFIG.RARITIES[item.rarity].label}</div>
